...
namespace WebApi.DbOperations
{
    public class DataGenerator
    {
        ...
        public static BoughtMovie[] BoughtMovies =
        {
            new BoughtMovie(){  CustomerId=1,  MovieId=1 },
            new BoughtMovie(){  CustomerId=2,  MovieId=2 },
            new BoughtMovie(){  CustomerId=3,  MovieId=3 },
            new BoughtMovie(){  CustomerId=4,  MovieId=4 }
        };
